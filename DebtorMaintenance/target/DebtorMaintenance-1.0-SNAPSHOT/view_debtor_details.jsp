<%@ page import="project.bfour.debtormaintenance.dao.DebtorDao" %>
<%@ page import="project.bfour.debtormaintenance.model.DetailsForm" %>
<%@ page import="project.bfour.debtormaintenance.dao.MySqlConn" %>
<%@ page import="java.sql.SQLException" %>
<%@ page import="project.bfour.debtormaintenance.customexceptions.UnauthException" %>
...
<%
    ...
    try {
        detailsForm = DebtorDao.getDebtorDetailsByTxnId(MySqlConn.getCon(), request.getParameter("txnId"));
    } catch (SQLException e) {
        e.printStackTrace();
    }
    request.setAttribute("debtorForm", detailsForm);
%>
<div class="container">
